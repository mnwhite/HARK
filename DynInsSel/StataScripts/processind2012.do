...
gen totalprem = 0
replace totalprem = premR3 if PANEL == 16
replace totalprem = premR1 if PANEL == 17
by DUPERSID: keep if _n == 1
keep DUPERSID totalprem
sort DUPERSID
save tempprem2012.dta, replace

use raw2012.dta
keep PANEL PID DUID DUPERSID FAMIDYR REFPRS31 REFPRS42 REFPRS53 RFREL31X RFREL42X RFREL53X RUSIZE31 RUSIZE42 RUSIZE53 RULETR31 RULETR42 RULETR53 AGE31X AGE42X AGE53X SEX RACEV1X RACETHX MARRY31X MARRY42X MARRY53X SPOUID31 SPOUID42 SPOUID53 HIDEG RTHLTH31 RTHLTH42 RTHLTH53 EMPST31 EMPST42 EMPST53 HRWG31X HRWG42X HRWG53X HOUR31 HOUR42 HOUR53 SELFCM31 SELFCM42 SELFCM53 OFFER31X OFFER42X OFFER53X CHOIC31 CHOIC42 CHOIC53 HELD31X HELD42X HELD53X OFREMP31 OFREMP42 OFREMP53 NUMEMP31 NUMEMP42 NUMEMP53 CHGJ3142 CHGJ4253 TTLP12X FAMINC12 POVLEV12 WAGEP12X BUSNP12X TRIAT12X MCDAT12X PUBAT12X PRIVAT12 UNINS12 TOTTCH12 TOTEXP12 TOTSLF12 TOTMCR12 TOTMCD12 TOTPRV12 TOTVA12 TOTTRI12 TOTOFD12 TOTSTL12 TOTWCP12 TOTOPR12 TOTOPU12 TOTOSR12 
...
rename TTLP12X persinc
rename FAMINC12 faminc
rename POVLEV12 povertypct
rename WAGEP12X wageinc
rename BUSNP12X businc
rename TRIAT12X tricareAT
rename MCDAT12X medicaidAT
rename PUBAT12X publicAT
rename PRIVAT12 privateAT
rename UNINS12 uninsured
rename TOTTCH12 nonRXmed
rename TOTEXP12 totalmed
rename TOTSLF12 OOPmed
rename TOTMCR12 mcrmed
rename TOTMCD12 mcdmed
rename TOTPRV12 privmed
rename TOTVA12 vetmed
rename TOTTRI12 trimed
rename TOTOFD12 fedmed
rename TOTSTL12 statemed
rename TOTWCP12 wcmed
rename TOTOPR12 oprivmed
rename TOTOPU12 opubmed
rename TOTOSR12 osrcmed
gen year = 2012
order year

sort DUPERSID
merge 1:1 DUPERSID using tempprem2012.dta
save ind2012.dta, replace
